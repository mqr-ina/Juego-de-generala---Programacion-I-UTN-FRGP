...
#include <time.h>
/* Usar en el main (si es un proyecto), o en el cpp para que compile.
...
int compEscalera (int v[], int tam); /// comprueba si hay o no escalera en el vector

bool todosIguales (int v[], int tam); /// compara los valores de un vector si son iguales o no

bool compararSexteto (int v[], int tam); //compara los valores en busca de un sexteto
